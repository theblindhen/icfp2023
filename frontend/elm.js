...
var $author$project$Main$Attendee = F3(
	function (x, y, tastes) {
		return {tastes: tastes, x: x, y: y};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Main$decodeAttendee = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Main$Attendee,
...
var $author$project$Main$decodeMusicians = $elm$json$Json$Decode$int;
var $author$project$Main$Pillar = F2(
	function (center, radius) {
		return {center: center, radius: radius};
	});
var $author$project$Main$decodeCenter = A2(
	...
	$elm$json$Json$Decode$list($elm$json$Json$Decode$float));
var $author$project$Main$decodePillar = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Pillar,
	A2($elm$json$Json$Decode$field, 'center', $author$project$Main$decodeCenter),
	A2($elm$json$Json$Decode$field, 'radius', $elm$json$Json$Decode$float));
var $author$project$Main$decodeStageBottomLeft = A2(
	$elm$json$Json$Decode$map,
	function (l) {
		if ((l.b && l.b.b) && (!l.b.b.b)) {
			var x = l.a;
...
var $author$project$Main$decodeProblem = A9(
	$elm$json$Json$Decode$map8,
	$author$project$Main$Problem,
	A2($elm$json$Json$Decode$field, 'room_width', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'room_height', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'stage_width', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'stage_height', $elm$json$Json$Decode$float),
	A2($elm$json$Json$Decode$field, 'stage_bottom_left', $author$project$Main$decodeStageBottomLeft),
	A2(
		$elm$json$Json$Decode$field,
		'musicians',
		$elm$json$Json$Decode$list($author$project$Main$decodeMusicians)),
	A2(
		$elm$json$Json$Decode$field,
		'attendees',
	...
	A2(
		$elm$json$Json$Decode$field,
		'pillars',
		$elm$json$Json$Decode$list($author$project$Main$decodePillar)));
		...
		switch (msg.$) {
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$elm$http$Http$get(
								{
									expect: $elm$http$Http$expectString($author$project$Main$LoadedProblem),
			...
			case 'LoadedProblem':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						function () {
							var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$decodeProblem, res);
							if (_v1.$ === 'Ok') {
								var problem = _v1.a;
								return _Utils_update(
									model,
									{
										problem: $elm$core$Maybe$Just(problem)
									});
							} else {
								var err = _v1.a;
								return _Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just(
											'Failed to decode problem: ' + $elm$json$Json$Decode$errorToString(err))
									});
							}
						}(),
						$elm$core$Platform$Cmd$none);
...
var $author$project$Main$LoadProblem = function (a) {
	return {$: 'LoadProblem', a: a};
};
var $author$project$Main$ProblemFieldUpdated = function (a) {
	return {$: 'ProblemFieldUpdated', a: a};
};
...
var $author$project$Main$viewLoadProblem = function (m) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Problem Id: '),
						$rundis$elm_bootstrap$Bootstrap$Form$Input$text(
						_List_fromArray(
							[
								$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Main$ProblemFieldUpdated)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$author$project$Main$LoadProblem(m.problemId)),
								$rundis$elm_bootstrap$Bootstrap$Button$primary
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Load problem')
							]))
					]))
			]));
};
				...
				[
					...
					A2(
						...
						function (pillar) {
							return A2(
								$joakin$elm_canvas$Canvas$circle,
								_Utils_Tuple2(pillar.center.a * scale, pillar.center.b * scale),
								pillar.radius * scale);
						},
						p.pillars)),
					attendeeShapes,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$PlaceRandomly),
									$rundis$elm_bootstrap$Bootstrap$Button$primary
								]),
							_List_fromArray(
								[
